<nav x-data="{ open: false }" style="background-color: #C2D3CD; border-bottom: 1px solid #AFBFC0;">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('petsitter-adverts.index')" :active="request()->routeIs('petsitter-adverts.index')">
                {{ __('Oppassers') }}
            </x-responsive-nav-link>
